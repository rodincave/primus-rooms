...
/**
 * Set reciepients ids when brodcasting.
 *
 * @param {String|Array} ids
 * @return {Rooms} this;
 * @api public
...
Rooms.prototype.to = function to(ids) {
  this.__to = ids;
  return this;
};
...
Rooms.prototype.broadcast = function broadcast(data, method) {
  ...
  var options = { rooms: this.__rooms, except: this.__except, to: this.__to, method: method };
...
/**
 * Reset rooms, except and to properties.
 *
 * @return {Rooms} this
 * @api private
 */
...
['__except', '__rooms', '__to'].forEach(function each(fn) {
  var ns = fn + '__';
